...
#endif
#define PED_CAR_RENDER_DIST_MULT 3.0f
#define PED_CAR_DENSITY_AREA_FACTOR (PED_CAR_RENDER_DIST_MULT * PED_CAR_RENDER_DIST_MULT)
#define PED_SWIMMING
...
enum Config {
	...
	MODELINFOSIZE = 8000,	// 3150 on PS2
	...
	SIMPLEMODELSIZE = 7000,	// 2910 on PS2
	MLOMODELSIZE = 1,
	MLOINSTANCESIZE = 1,
	TIMEMODELSIZE = 300,
	CLUMPMODELSIZE = 5,
	...
	TWODFXSIZE = 8000,	// 1210 on PS2

	MAXVEHICLESLOADED = 50, // 70 on mobile

	NUMOBJECTINFO = 500, // object.dat

	// Pool sizes
#ifdef PED_CAR_RENDER_DIST_MULT
	NUMPTRNODES = 250000,
	NUMENTRYINFOS = 120000,
	NUMPEDS = 320,
	NUMVEHICLES = 256,
#else
...
#endif
	NUMBUILDINGS = 25000,  // 4915 on PS2
	NUMTREADABLES = 4000,
	NUMOBJECTS = 1000,
	NUMDUMMIES = 12000, // 2368 on PS2
	NUMAUDIOSCRIPTOBJECTS = 256,
	NUMCUTSCENEOBJECTS = 200,
	...
	// Path data
	NUM_PATHNODES = 25000,
	NUM_CARPATHLINKS = 12000,
	NUM_MAPOBJECTS = 4000,
	NUM_PATHCONNECTIONS = 60000,
	...
	NUMVISIBLEENTITIES = 45000,
	NUMINVISIBLEENTITIES = 8000,
